<div style="background-color: white; border: 1px dotted gray; padding: 10px;">
    ...
    <div style="float:right">
        <b>Wipe</b> : <a href='<?php echo WPS_ADMIN_PAGE; ?>&tab=daily&wipe=daily'>daily</a> - <a href='<?php echo WPS_ADMIN_PAGE; ?>&tab=daily&wipe=full'>full</a>
    </div>
</div>
<?php if( $nLogs ): ?>
...
<table width="100%" cellpadding="0" cellspacing="1" style="background-color: white; border: 1px dotted gray; padding: 0;">
    <tr><td>
        <b>Logged <?php echo $nLogs ;?> attack<?php echo $nLogs == 1 ? '' : 's'; ?> within last 24 hours.</b>
        <br>
        <br>
        <table width="100%" cellpadding="0" cellspacing="1" style="background-color: white; border: 1px dotted gray; padding: 0;">
            <tr>
            ...
            <tr style='<?php echo $i % 2 != 0 ? "background-color: #EEE;" : ""; ?>'>
                ...
                <td style='padding:1px;' align='center'>
                    ...
                    <div style="float:right; position: relative; right: 40px;">
                        ...
                        <?php else: ?>
                            <a href='<?php echo WPS_ADMIN_PAGE; ?>&tab=daily&unban=<?php echo $log->address; ?>' class="tooltip" title="Unban this address.">
                ...
                <td style='padding:1px;' align='center'>
                    <a href='<?php echo WPS_ADMIN_PAGE; ?>&tab=daily&delete=<?php echo $log->id;?>'>
