...
_fa.width="50px";
_fa.height="25px";
_fb.href=wmdL10n.wmdLink.href;
_fb.target="_blank";
_fb.title=wmdL10n.wmdLink.title;
...
if(!_151.selection){
if(_152){
_151.selection=wmdL10n.selection.alt;
}else{
_151.selection=wmdL10n.selection.link;
}
}
}
_153();
...
if(_152){
_154=_6.prompt("<p style='margin-top: 0px'>" + wmdL10n.prompt.img + "</p>","http://",_155);
}else{
_154=_6.prompt("<p style='margin-top: 0px'>" + wmdL10n.prompt.link + "</p>","http://",_155);
}
return true;
}
};
_8.bold={};
_8.bold.description=wmdL10n.description.bold;
_8.bold.image="images/bold.png";
_8.bold.key="b";
_8.bold.textOp=_8.doBold;
_8.italic={};
_8.italic.description=wmdL10n.description.italic;
_8.italic.image="images/italic.png";
_8.italic.key="i";
_8.italic.textOp=_8.doItalic;
_8.link={};
_8.link.description=wmdL10n.description.link;
...
_8.undo={};
_8.undo.description=wmdL10n.description.undo;
_8.undo.image="images/undo.png";
_8.undo.execute=function(_15b){
_15b.undo();
};
_8.redo={};
_8.redo.description=wmdL10n.description.redo;
