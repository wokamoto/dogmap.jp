...
<div id="content">
	<div id="main">
		<p class="topicPath"><a href="<?php bloginfo('home'); ?>"><?php _e('Home'); ?></a> &gt; <?php _e('Tags'); ?> &gt; <span class="current"><?php single_tag_title(); ?></span></p>
...
<!--end pagenavi -->
		<p class="topicPath"><a href="<?php bloginfo('home'); ?>"><?php _e('Home', 'vicuna'); ?></a> &gt; <?php _e('Tags'); ?> &gt; <span class="current"><?php single_cat_title(); ?></span></p>
	</div><!-- end main-->
